...
<head>
  ...
  <title>Lucha Libre MX - WWE Superestrellas</title>
  <style>
    body {
      margin: 0;
    ...
    .banner {
      background-image: url('https://upload.wikimedia.org/wikipedia/commons/f/f8/LuchaLibre_Mask.jpg');
...
<body>
  ...
  <script>
    const luchadores = [
      ...
      {nombre: "Edge", imagen: "https://upload.wikimedia.org/wikipedia/commons/2/27/Edge_WrestleMania_31.jpg", descripcion: "Veterano con gran legado."},
